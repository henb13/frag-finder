...
exports.addSpaces =
    exports.getIngameClockTime =
    exports.getFragSpeed =
    exports.getFragTypeDetails =
    exports.incrementWeaponKillCount =
    exports.getWeaponsUsed =
    exports.createFiles =
        void 0;
...
async function createFiles(data, options = {}) {
    ...
    await fs_1.promises.writeFile(`${dir}/${printFileName}`, "\n");
    for (const match of data) {
        ...
        match.rounds.forEach(({ roundNumber, highlights }) => {
            ...
            highlights.forEach((h) => {
                const playerCamelized = (0, utils_1.camelizeIsh)(h.playerName);
                const teamCamelized = (0, utils_1.camelizeIsh)(h.team ?? "");
                ...
                const clockTimeFirstKill = getIngameClockTime(
                    constants_1.CSGO_ROUND_LENGTH - h.allKillsThatRoundForPlayer[0].time + 1
                );
        ...
        await fs_1.promises.appendFile(
            `${dir}/${printFileName}`,
            matchText.join("") + "\n\n\n"
        );
    }
...
exports.getWeaponsUsed = getWeaponsUsed;
function incrementWeaponKillCount(name, obj) {
    obj[name] = obj[name] + 1 || 1;
}
exports.incrementWeaponKillCount = incrementWeaponKillCount;
...
exports.getFragTypeDetails = getFragTypeDetails;
function getFragSpeed(allKillsThatRoundForPlayer) {
    ...
    const lastKillTimestamp =
        constants_1.CSGO_ROUND_LENGTH - allKillsThatRoundForPlayer[killAmount - 1].time + 1;
    const firstKillTimestamp =
        constants_1.CSGO_ROUND_LENGTH - allKillsThatRoundForPlayer[0].time + 1;
...
exports.getFragSpeed = getFragSpeed;
...
exports.getIngameClockTime = getIngameClockTime;
